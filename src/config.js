...
module.exports = {
  ...
  SMTP_SECURE: bool(env.SMTP_SECURE, false),
  MAIL_FROM: env.MAIL_FROM || '',
  DOWNLOAD_LINK_TTL_MIN: int(env.DOWNLOAD_LINK_TTL_MIN, 15),
  BACKUP_DIR: resolvePath(env.BACKUP_DIR, './backups'),
  BACKUP_KEEP: int(env.BACKUP_KEEP, 10),
  DEFAULT_LOCALE: env.DEFAULT_LOCALE === 'en' ? 'en' : 'es',
